...
describe('DELETE venues route', () =>{
    test('Rejects delete-all request: (status 405): Method not allowed.', 
        async() =>{
            const response = await request(app).delete('/venues')
    ...
    test('Responds with Validation Errors (status 400): Invalid reference Id', 
        async() =>{
            const response = await request(app).delete('/venues/64c9e4f2df7cc072af2acxx')
    ...
    test('Responds with Not Found (status 404): event does not exist.', 
        async() =>{
            const response = await request(app).delete('/venues/64c9e4f2df7cc072af2ac8a4')
    ...
    test('Responds with deleted resource Id (status 200): Delete Operation success.', 
        async() =>{
            const response = await request(app).delete('/venues/64c9e4f2df7cc072af2ac9e4')
